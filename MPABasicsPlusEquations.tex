...
\title{MPA Summary Notes and Equations}
...
\begin{center}
	\begin{tikzpicture}
	%\draw[help lines] (0,-18) grid (12,1);
	
	\filldraw[fill=black] (0,0) rectangle (12,0.2);
	%supports
	\draw[->, very thick, black] (0,-1) -- (0,0);
	\draw[->, very thick, black] (12,-1) -- (12,0);
	%loads
	\draw[->, very thick, red] (3,1) -- (3,0.2);
	\draw[->, very thick, red] (6,1) -- (6,0.2);

	\draw[very thick, red] (6,0.5) -- (12,0.5);
	\draw[->, very thick, red] (7,0.5) -- (7,0.2);
	\draw[->, very thick, red] (8,0.5) -- (8,0.2);	
	\draw[->, very thick, red] (9,0.5) -- (9,0.2);
	\draw[->, very thick, red] (10,0.5) -- (10,0.2);
	\draw[->, very thick, red] (11,0.5) -- (11,0.2);
	\draw[->, very thick, red] (12,0.5) -- (12,0.2);
	...
	%labels
	\node [right] at (0,-1) {$R_A$};
	\node [right] at (12,-1) {$R_D$};
	\node [above, red, thick] at (9,0.5) {$\omega = 10 kNm^{-1}$};
	\node [above, red] at (3,1) {$F_B = 200 kN$};
	\node [above, red] at (6,1) {$F_C = 50 kN$};
...
\begin{equation}
\sum M_A = 200 \times 15 + 50 \times 30 + (10 \times 30) \times 45 + R_D \times 60 = 0 \to R_D = 300 kN 
\end{equation}  
 
\begin{equation}
\sum F_y = R_A - 200 - 50 - (10 \times 30) + 300 = 0 \to R_A = 250 kN 
\end{equation}  
...
\begin{center}
	...
	%labels
	\node [right] at (0,-1) {$R_A = 250 kN$};
	\node [right] at (12,-1) {$R_D = 300 kN$};
	\node [above, red, thick] at (9,0.5) {$\omega = 10 kNm^{-1}$};
	\node [above, red] at (3,1) {$F_B = 200 kN$};
	\node [above, red] at (6,1) {$F_C = 50 kN$};
	
	\node[below] at (6,-1.5) {\textbf{\texttt{Reaction Supports and Point Loads}}};
	
	
	\draw[very thick, blue] (0,-6) -- (9,-6);
	
	\draw[very thick, black] (0,-6) -- (0,-3.5);
	\draw[very thick, black] (0,-3.5) -- (3,-3.5);
	\draw[very thick, black] (3,-5.5) -- (3,-3.5);
	\draw[very thick, black] (3,-5.5) -- (6,-5.5);
	\draw[very thick, black] (6,-5.5) -- (6,-6.0);
	\draw[very thick, black] (6,-6.0) -- (12,-9.0);
	\draw[very thick, black] (12,-9.0) -- (12,-6.0);
	...
	\node [above left] at (0,-6) {$0kN$};
	\node [left] at (0,-3.5) {$250$};
	\node [above] at (6,-5.5) {$50$};
	\node [right] at (12,-9.0) {$-300$};
	\node [right] at (8,-7.0) {$-100$};
	\node [right] at (10,-8.0) {$-200$};
		

	
	\node[below] at (6,-9.0) {\textbf{\texttt{Shear Force Diagram}}};
	
	\draw[very thick, blue] (0,-16) -- (12,-16);
	
	\draw[very thick, black] (0,-16) -- (3,-12.0);
	\draw[very thick, black] (3,-12) -- (6,-11.5);


	\draw[very thick] (6,-11.5) to [out=00,in=115] (12,-16);
	
	\node [above left] at (0,-16) {$0kNm$};
	\node [left] at (3,-12) {$3750$};
	\node [above left] at (6,-11.5) {$4500$};
	\node [above right] at (8,-12) {$4000$};	
	\node [below right] at (10.2,-13) {$2500$};
	
	\node[below] at (6,-17.0) {\textbf{\texttt{Bending Moment Diagram}}};
...
\begin{center}
	...
	\draw[gray, fill = gray] (0,0) rectangle (1,5);
	\draw[gray, fill = gray] (0,0) rectangle (2,-1);
	...
	\node [left] at (-1, 2) {$60mm$};
	\node [below] at (1, -2.2) {$20mm$};
	
	\node[below] at (1,-3) {\textbf{\texttt{"L" Cross-section}}};
	
	
	\draw[blue, fill = blue!30] (8,0) rectangle (9,5);
	\draw[green, fill = green!30] (8,0) rectangle (10,-1);
	
	\draw [dashed, very thick, red] (7.5, -0.5) -- (10.5, -0.5);
	\draw [dashed, very thick, red] (7.5, 2.5) -- (10.5, 2.5);
	\draw [ultra thick, red] (6.5, 2.25) -- (10.5, 2.25);
	\draw (6.5, -1) -- (7.5, -1);
	\draw [<->] (7, -1) -- (7, 2.25);
	
	
	\node [above] at (8.5, 2.5) {$A$};
	\node [above] at (9, -1) {$B$};
	\node [left] at (7, 1) {$\bar{y}$};
	
	
	\node[below] at (9,-3) {\textbf{\texttt{Two rectangles A and B}}};
...
To calculate $\bar{y}$ we apply 

\begin{equation}
\bar{y}={\frac {\sum C_{i_{y}}A_{i}}{\sum A_{i}}}
\end{equation}

\begin{equation}
\bar{y}=\frac {(5 \times (10 \times 20) + 30 \times (10 \times 50)) }{(10 \times 20) + (10 \times 50)} = 22.86mm
\end{equation}


\bigskip

The value for $\bar{x}$ can be found in a similar way, $\bar{x}= 6.43mm$.
...
\begin{center}
	...
	\draw[blue, fill = gray!30] (0,0) rectangle (3,5);
	%\draw[gray, fill = gray] (0,0) rectangle (2,-1);
...
%	
	...
	\draw (3.2, 0) -- (4.2, 0);
	\draw (3.2, 2.5) -- (4.2, 2.5);
	\draw[<->] (3.7, 0) -- (3.7, 2.5);	
	
	\draw [ultra thick, red] (-0.1, 2.5) -- (3.1, 2.5);
	\draw [ultra thick, cyan] (1.5, -0.1) -- (1.5, 5.1);
	
	
	\node [left] at (-1, 2.5) {$H$};
	\node [below] at (1.5, -0.7) {$W$};
	\node [right] at (3.7, 1.25) {$\frac{H}{2}$};
	
	\node[below] at (1,-1.5) {\textbf{\texttt{Rectangle Height $H$ and Width $W$}}};
...
\begin{center}
	...
	\draw[blue, fill = gray!30] (0,2) rectangle (3,4);
	%\draw[gray, fill = gray] (0,0) rectangle (2,-1);
	...
	\draw [ultra thick, red] (-1, 0) -- (3.1, 0);
	\draw [ultra thick, dashed, cyan] (-0.1, 3) -- (3.1, 3);
	
	
	\node [left] at (-1, 3) {$H$};
	\node [above] at (1.5, 4.7) {$W$};
	\node [right] at (3.7, 1.25) {$d$};
...
\draw [line width = 0.2cm, cyan] (0,0.2) arc [radius=15.1, start angle=75, end angle= 105];

\draw [line width = 0.2cm, blue] (0,-0.2) arc [radius=14.9, start angle=75, end angle= 105];


\draw [ultra thick, dashed] (0,0) arc [radius=15, start angle=75, end angle= 105];	

%	
	\draw [ultra thick, red] (0, 0) -- (1, 0);
	\draw [very thick, cyan] (0, .2) -- (1, 1);
	\draw [very thick, blue] (0, -.2) -- (1, -1);	
%	\draw [ultra thick, dashed, cyan] (-0.1, 3) -- (3.1, 3);
%	
%	
	\node [right, red] at (1, 0) {$NA$};
	\node [above] at (1.0, 1.1) {$Tension$};
	\node [below] at (1, -1.1) {$Compression$};
%	
%	\node[below] at (1,-1.5) {\textbf{\texttt{Rectangle Height $H$ and Width $W$}}};
...
From the theory of bending equation, it can be seen that the magnitude of the bending stress $\sigma_{bend}$ for a particular cross-section subjected to a bending moment $M$ and with a 2nd moment of area $I$, varies through the cross-section and hence is dependent upon the value of $y$.


\bigskip


\textbf{Symmetrical Cross-section}
...
\begin{center}
	\begin{tikzpicture}
	\draw[help lines] (-4,-2) grid (9,2);
	\draw[blue, fill = gray!30] (1,-1.5) rectangle (3,1.5);
	\draw[gray, fill = yellow] (-2.0,0) circle [radius = 1.5];
	
	
	\draw [ultra thick, red, dashed] (-4, 0) -- (9, 0);
	%\draw [ultra thick, dashed, cyan] (-0.1, 3) -- (3.1, 3);
	\draw [ultra thick] (7, 1.5) -- (9, 1.5);
	\draw [ultra thick] (5, -1.5) -- (7, -1.5);
	\draw [ultra thick, dashed, cyan] (5, -1.5) -- (9, 1.5);
	\draw [ultra thick, green] (7, -1.5) -- (7, 1.5);	
	
	\node [right] at (9, 0) {$NA$};
	\node [right] at (9, 1.5) {$+ \sigma_{bend}$};
	\node [below, left] at (5, -1.5) {$- \sigma_{bend}$};	

	
	%\node[below] at (1,-2) {\textbf{\texttt{Rectangle Height $H$ and Width $W$}}};
...
\textbf{Non-Symmetrical Cross-section}
...
\begin{center}
	\begin{tikzpicture}
	\draw[help lines] (-4,-2) grid (9,2);
	\draw[gray, fill = gray] (0,-1) rectangle (3,-.5);
	\draw[gray, fill = gray] (1.25, -.5) rectangle (1.75,1.5);	
	
	%\draw[gray, fill = yellow] (-2.0,0) circle [radius = 1.5];
	
	
	\draw [ultra thick, red, dashed] (-4, -.10) -- (9, -.10);
	%\draw [ultra thick, dashed, cyan] (-0.1, 3) -- (3.1, 3);
	\draw [ultra thick] (7, 1.5) -- (9, 1.5);
	\draw [ultra thick] (6, -1) -- (7, -1);
	\draw [ultra thick, dashed, cyan] (6, -1) -- (9, 1.5);
	\draw [ultra thick, green] (7, -1) -- (7, 1.5);	
	
	\node [right] at (9, 0) {$NA$};
	\node [right] at (9, 1.5) {$+ \sigma_{bend}$};
	\node [below, left] at (6, -1) {$- \sigma_{bend}$};	
...
\draw[help lines] (-4,-2) grid (9,5);
\node[circle,fill=blue,inner sep=2.5mm] (a) at (0,0) {};
\node[circle,fill=blue,inner sep=2.5mm] (b) at (2,2) {};
\node[circle,fill=blue,inner sep=2.5mm] (c) at (4,0) {};
\node[circle,fill=blue,inner sep=2.5mm] (d) at (6,2) {};
...
\draw[decoration={aspect=0.3, segment length=3mm, amplitude=3mm,coil},decorate] (4,5) -- (c); 
\draw[decoration={aspect=0.3, segment length=1.5mm, amplitude=3mm,coil},decorate] (6,5) -- (d); 


\fill [pattern = north east lines] (-1,5) rectangle (7,5.2);
\draw[thick] (-1,5) -- (7,5);

\draw [dashed, red, ultra thick] (-2, 1) -- (8, 1);

\draw [->, blue, ultra thick] (0, -1) -- (6, -1);
\draw [|->, thick] (7, 0) -- (7, 1);

\node [above, red] at (-2, 1) {$Neutral Position$};
\node [below, blue] at (6, -1) {$Time$};
\node [below right] at (7, 1) {$x(t)$};

\end{tikzpicture}
\end{center}


The Position of the object [point mass] in Simple Harmonic Motion with a phase angle $\phi$ = 0, is given by;
...
\textbf{Summary of Equations of Motion for SHM}
...
The General Velocity of an object in Simple Harmonic Motion;
